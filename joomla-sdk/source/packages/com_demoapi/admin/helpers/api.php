        ...
        if ($statusResponse->code != 200) {
            if ($json['err_code'] == 1 && $try == 1) {
                ...
                if (self::createApiKey(array(
                    'params' => array(
                        'api_user' => JComponentHelper::getParams('com_demoapi')->get('api_user'),
                        'api_host' => JComponentHelper::getParams('com_demoapi')->get('api_host'),
                        'api_password' => JComponentHelper::getParams('com_demoapi')->get('api_password')
                    )
                ))) {
                    $try++;

...
/**
 * Form Field to display a list of the layouts for module display from the module or template overrides group by joomla version.
 *
 * @package     Joomla.Platform
 * @subpackage  Form
 * @since       11.1
 */
class JFormFieldModuleLayoutByJoomlaVersion extends JFormField
{
	/**
	 * The form field type.
	 *
	...
	protected function getInput()
	{
		...
		if ($module && $client)
		{
			...
			$module_path = JPath::clean($client->path . '/modules/' . $module . '/tmpl/'.$jversion.'/');

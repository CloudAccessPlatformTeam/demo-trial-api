...
class CloudaccessApiController extends DRController
{
    ...
    public function checkStatus()
    {
        ...
        foreach ($processes as $id => $data) {
            ...
            $postData = array(
                ...
                'p_opid' => $id,
                'access_token' => HelperCloudaccessApiApi::getApiKey()
            );
            // Initinalise vars
        ...
        $session->set('cloudaccessapi.process',$processes);
    ...
    public function checkDomain()
    {
        ...
        $subdomain = CloudaccessApiHelperModule::getParams($input->get('mid',0,'int'))->get('subdomain','.cloudaccess.net');

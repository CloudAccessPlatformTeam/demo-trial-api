 ...
 * @since       3.0
 */
class CloudaccessApiViewCloudaccessApi extends DRView
{
    /**
     * Display the view
     *
    ...
    public function display($tpl = null)
    {
        ...
        if ($canDo->get('core.admin'))
        {
            ...
            $actModel = DRModel::getInstance('Activationcodes','CloudaccessapiModel');
            ...
            JFactory::getLanguage()->load('mod_createcloudaccessdemo', JPATH_SITE);
        }

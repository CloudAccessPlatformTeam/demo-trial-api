...
// Register alias for work on 2.5/3.0
if (version_compare(JVERSION, '3.0', 'ge'))
{
    class_alias('JControllerLegacy','DRController');
    class_alias('JModelLegacy','DRModel');
    class_alias('JViewLegacy','DRView');
}
else
{
    class_alias('JController','DRController');
    class_alias('JModel','DRModel');
...
return yourls_http_build_url( $url, $parts, $flags, $new_url );
}
}
...
* @return string
*/
function yourls_http_build_url(/*string|array*/ $url, /*string|array*/ $parts = array(), /*int*/ $flags = HTTP_URL_REPLACE, /*array*/ &$new_url = false) {
